...
class BamlAsyncClient:
    ...
    async def ExtractDocumentFieldsFromPDF(self, document: baml_py.Pdf,extraction_prompt: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractDocumentFieldsFromPDF", args={
    ...
    async def ExtractFromPDF(self, document: baml_py.Pdf,schema_description: str,field_names: typing.List[str],
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractFromPDF", args={
...
class BamlStreamClient:
    ...
    def ExtractDocumentFieldsFromPDF(self, document: baml_py.Pdf,extraction_prompt: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractDocumentFieldsFromPDF", args={
            "document": document,"extraction_prompt": extraction_prompt,
        })
        return baml_py.BamlStream[str, str](
          __result__,
    ...
    def ExtractFromPDF(self, document: baml_py.Pdf,schema_description: str,field_names: typing.List[str],
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractFromPDF", args={
            "document": document,"schema_description": schema_description,"field_names": field_names,
        })
        return baml_py.BamlStream[stream_types.DocumentExtractionResult, types.DocumentExtractionResult](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def ExtractFromPDF(self, document: baml_py.Pdf,schema_description: str,field_names: typing.List[str],
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractFromPDF", args={
            "document": document,"schema_description": schema_description,"field_names": field_names,
        }, mode="request")
        return __result__
    async def ExtractResume(self, resume: str,
