...
class BamlAsyncClient:
    ...
    async def ExtractDocumentFields(self, document_image: baml_py.Image,extraction_prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ExtractDocumentFields(document_image=document_image,extraction_prompt=extraction_prompt,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractDocumentFields", args={
    ...
    async def ExtractFromDocumentImage(self, document_image: baml_py.Image,schema_description: str,field_names: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> types.DocumentExtractionResult:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ExtractFromDocumentImage(document_image=document_image,schema_description=schema_description,field_names=field_names,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractFromDocumentImage", args={
...
class BamlStreamClient:
    ...
    def ExtractDocumentFields(self, document_image: baml_py.Image,extraction_prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractDocumentFields", args={
            "document_image": document_image,"extraction_prompt": extraction_prompt,
        })
    ...
    def ExtractFromDocumentImage(self, document_image: baml_py.Image,schema_description: str,field_names: typing.List[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.DocumentExtractionResult, types.DocumentExtractionResult]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractFromDocumentImage", args={
            "document_image": document_image,"schema_description": schema_description,"field_names": field_names,
        })
...
class BamlHttpRequestClient:
    ...
    async def ExtractDocumentFields(self, document_image: baml_py.Image,extraction_prompt: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractDocumentFields", args={
            "document_image": document_image,"extraction_prompt": extraction_prompt,
        }, mode="request")
        return __result__
    async def ExtractFromDocumentImage(self, document_image: baml_py.Image,schema_description: str,field_names: typing.List[str],
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractFromDocumentImage", args={
            "document_image": document_image,"schema_description": schema_description,"field_names": field_names,
        }, mode="request")
        return __result__
    async def ExtractResume(self, resume: str,
